package tw.edu.ntub.imd.birc.knowledgehub.databaseconfig;
...
@EnableJpaRepositories(basePackages = "tw.edu.ntub.imd.birc.knowledgehub.databaseconfig.dao")
@EnableJpaAuditing
@EnableTransactionManagement
@EntityScan(basePackages = "tw.edu.ntub.imd.birc.knowledgehub.databaseconfig.entity")
public class Config {
