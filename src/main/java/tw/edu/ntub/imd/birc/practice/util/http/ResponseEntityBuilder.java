...
import tw.edu.ntub.imd.birc.practice.util.json.ResponseData;
import tw.edu.ntub.imd.birc.practice.util.json.array.ArrayData;
import tw.edu.ntub.imd.birc.practice.util.json.array.CollectionArrayData;
import tw.edu.ntub.imd.birc.practice.util.json.array.MapArrayData;
import tw.edu.ntub.imd.birc.practice.util.json.object.ObjectData;
import tw.edu.ntub.imd.birc.practice.dto.CodeEntry;
import tw.edu.ntub.imd.birc.practice.util.function.AddObjectDataConsumer;
import tw.edu.ntub.imd.birc.practice.util.function.AddObjectDataMapConsumer;
