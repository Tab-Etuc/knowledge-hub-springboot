package tw.edu.ntub.imd.birc.knowledgehub.util.file;

import lombok.experimental.UtilityClass;
import org.springframework.lang.NonNull;
import org.springframework.lang.Nullable;
import tw.edu.ntub.birc.common.exception.UnknownException;
import tw.edu.ntub.imd.birc.knowledgehub.exception.file.FileExtensionNotFoundException;
import tw.edu.ntub.imd.birc.knowledgehub.exception.file.InvalidCharsetException;
import tw.edu.ntub.imd.birc.knowledgehub.exception.file.InvalidOptionException;
import tw.edu.ntub.imd.birc.knowledgehub.exception.file.UnauthorizedException;
...
public class FileUtils {
    ...
    public Path getFilePath(@NonNull String filePath) {
        try {
            ...
            throw new tw.edu.ntub.imd.birc.knowledgehub.exception.file.InvalidPathException(e, filePath);
        }
    }
    ...
    public Path getDirectoryPath(@NonNull String firstDirectoryPath, String... subDirectoryPath) {
        try {
            ...
            throw new tw.edu.ntub.imd.birc.knowledgehub.exception.file.InvalidPathException(e, firstDirectoryPath, subDirectoryPath);
        }
    }
