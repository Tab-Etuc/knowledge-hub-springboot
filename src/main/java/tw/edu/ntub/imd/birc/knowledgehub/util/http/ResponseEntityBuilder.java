package tw.edu.ntub.imd.birc.knowledgehub.util.http;
...
import tw.edu.ntub.imd.birc.knowledgehub.util.function.TripleConsumer;
import tw.edu.ntub.imd.birc.knowledgehub.util.json.ResponseData;
import tw.edu.ntub.imd.birc.knowledgehub.util.json.array.ArrayData;
import tw.edu.ntub.imd.birc.knowledgehub.util.json.array.CollectionArrayData;
import tw.edu.ntub.imd.birc.knowledgehub.util.json.array.MapArrayData;
import tw.edu.ntub.imd.birc.knowledgehub.util.json.object.ObjectData;
import tw.edu.ntub.imd.birc.knowledgehub.dto.CodeEntry;
import tw.edu.ntub.imd.birc.knowledgehub.util.function.AddObjectDataConsumer;
import tw.edu.ntub.imd.birc.knowledgehub.util.function.AddObjectDataMapConsumer;
